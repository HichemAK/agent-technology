...
public class AgentPhone extends Agent {
    ExpertSystem ES = new ExpertSystem("examples/phone.es");

    public AgentPhone() throws FileNotFoundException {
    }
    ...
    class Launch extends CyclicBehaviour {
        ...
        public void action() {
            ...
            AgentPhone agent = (AgentPhone) this.myAgent;
